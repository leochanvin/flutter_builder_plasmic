...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: RCuBMqy0CZW8/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__aPl)}
                    label={"Item 3"}
                    value={"item3"}
                  />
