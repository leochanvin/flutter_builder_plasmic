...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: b6tNq7VAA1a2/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rwSn)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__y41H)}>
            <div
              className={classNames(
                projectcss.all,
