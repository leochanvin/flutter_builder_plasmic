...
import Button from "../../Button"; // plasmic-import: xwsQuqJI9T8H/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: Yzu8l2Jjln7_/css
...
export type PlasmicPopover__VariantsArgs = {
  addWidget?: SingleBooleanChoiceArg<"addWidget">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.addWidget
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        {
          [sty.ariaDialogTriggeraddWidget]: hasVariant(
            $state,
            "addWidget",
            "addWidget"
          )
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__ivuWp)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__wzeYh)}
            label={"Open Popover"}
          />
        ),
