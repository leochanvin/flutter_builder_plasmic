...
import MenuPopover from "../../MenuPopover"; // plasmic-import: RCuBMqy0CZW8/component
import MenuItem from "../../MenuItem"; // plasmic-import: b6tNq7VAA1a2/component
import MenuSection from "../../MenuSection"; // plasmic-import: -BoOsBgt6XwQ/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: r_7ePccTT7BK/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__iGjIh)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
