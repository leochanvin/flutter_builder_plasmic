...
export type FolderOpenSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FolderOpenSvgIcon(props: FolderOpenSvgIconProps) {
