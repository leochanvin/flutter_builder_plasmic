...
import sty from "./PlasmicSelectButton.module.css"; // plasmic-import: DPg0ApQ_34Tf/css
...
export interface DefaultSelectButtonProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicSelectButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__rr0Wp, {
          [sty.freeBoxcolor_neutral__rr0WPbilHo]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__rr0Wp28V5D3Mlfr]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__rr0WPnKzyK]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__rr0WPseFn0]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__rr0WpWqAkB]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__rr0WpDdNbk]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__rr0Wpp9R3]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__rr0Wp3Mlfr]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zcv7, {
            [sty.freeBoxcolor_neutral__zcv7BilHo]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__zcv7C3FLm]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__zcv7SeFn0]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__zcv7DdNbk]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__zcv7P9R3]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__zcv73Mlfr]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__zcv7AIlCgBilHo]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__h2WpJ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__w9O2Q, {
            [sty.freeBoxiconEnd__w9O2Qxu1Yb]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__w9O2QseFn0]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__w9O2QDdNbk]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__w9O2Qp9R3]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___2Kb5)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSelectButton__ArgsType, ReservedPropsType> &
