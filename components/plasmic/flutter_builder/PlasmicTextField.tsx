...
import Label from "../../Label"; // plasmic-import: X1rLzBCI4G4J/component
import TextInput from "../../TextInput"; // plasmic-import: fNeSTvGFB_H6/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: xAMSIykj68vN/component
import Description from "../../Description"; // plasmic-import: s9JU8DR9oJw5/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: erV3fXnIteTe/css
...
export type PlasmicTextField__VariantsArgs = {
  ...
  properties?: SingleBooleanChoiceArg<"properties">;
};
...
function PlasmicTextField__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.properties
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <BaseTextField
      ...
      className={classNames(
        ...
        sty.ariaTextField,
        {
          ...
          [sty.ariaTextFieldproperties]: hasVariant(
            $state,
            "properties",
            "properties"
          )
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__fm3K9, {
          [sty.freeBoxiconEnd__fm3K9FxziE]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__fm3K9Cbg2D]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__fm3K98W09H]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__bKh4K, {
            [sty.freeBoxiconStart__bKh4Kcbg2D]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__bKh4K8W09H]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pmR9M)}
                role={"img"}
              />
            ),
        ...
        {(
          hasVariant($state, "properties", "properties")
            ? true
          ...
          <TextAreaInput
            ...
            className={classNames("__wab_instance", {
              ...
              [sty.textAreaInputproperties]: hasVariant(
                $state,
                "properties",
                "properties"
              )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___3OyNv, {
            [sty.freeBoxiconEnd___3OyNvfxziE]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___3OyNvcbg2D]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__xyVj)}
                role={"img"}
              />
            ),
